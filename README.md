...
This shows how we can start a java project using Maven. First, using a terminal, go to the directory where you want create the project.

mvn archetype:generate

Some projects will be listed and the project 'maven-archetype-quickstart' with its respective number will be suggested.
